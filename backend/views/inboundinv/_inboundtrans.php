    ...
    <div class="col-lg-12">
        <div class="panel panel-body">
            <div class="table-responsive" style="overflow-x: scroll;">
                <form id="form-recieve" action="<?= Url::to(['inboundinv/recieve'], true) ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="invoice_no" value="<?= $modelinv->docin_no; ?>">
                    <input type="hidden" name="invoice_id" value="<?= $modelinv->id; ?>">
                    <input type="hidden" name="currency_id" value="<?= $modelinv->currency_id; ?>">
                    <input type="hidden" name="invoice_date"
                           value="<?= date('d-m-Y', strtotime($modelinv->invoice_date)); ?>">
                    <table class="table table-importline">
                        ...
                        <?php foreach ($model as $value): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" class="productcode" name="product_id[]"
                                           value="<?= $value->product_id ?>">
                                    <input type="hidden" class="recid" name="recid[]" value="<?= $value->id ?>">
                                    <input type="text" style="width: 400px" class="form-control productname" name=""
                                ...
                                <td><input type="number" style="width: 100px" class="form-control line_packing"
                                           name="line_packing[]" readonly value="<?= $product_data->unit_factor ?>">
                                </td>
                                ...
                                <td><input type="text" style="width: 100px;text-align: right;"
                                           class="form-control line_bottle_qty" readonly name="line_bottle_qty[]"
                                           value="<?= number_format($bottle_qty) ?>"></td>
                                ...
                                <td><input style="width: 100px" type="text" class="form-control line_geo"
                                           name="line_geo[]" value="<?= $geo ?>" readonly></td>
                                <td><input type="text" style="width: 100px" class="form-control line_origin"
                                           name="line_origin[]" value="<?= $product_data->origin ?>" readonly></td>
                                <td><input type="text" style="width: 300px" class="form-control line_excise_no"
                                ...
                                <td><input type="text" style="width: 100px" class="form-control line_kno_date"
                                           name="line_kno_date[]"
