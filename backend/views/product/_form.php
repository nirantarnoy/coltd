                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <?= $form->field($model, 'price_carton_usd')->textInput(['maxlength' => true,'class'=>'form-control'])->label(false) ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <?= $form->field($model, 'price_carton_thb')->textInput(['maxlength' => true,'class'=>'form-control'])->label(false) ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
