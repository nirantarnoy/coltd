...
<div class="currency-index">
    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            <div class="btn-group">
                <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างสกุลเงิน'), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="pull-right">
                        <form id="form-perpage" class="form-inline" action="<?=Url::to(['currency/index'],true)?>" method="post">
