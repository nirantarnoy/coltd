    ...
    <div class="col-lg-12">
        ...
        <table class="table" border="0" style="width: 100%;border-collapse: collapse;">
            ...
            <tr >
                ...
                <td colspan="6" style="border: none;font-size: 14px;font-weight: bold">

                </td>

                <td colspan="2" style="text-align: right;font-size: 13px;font-weight: bold;border: none;">
                    Date: <?=date('d/m/Y',$model->require_date)?><br />
                    Invoice: <?=$model->sale_no?>
                </td>
            </tr>
            <tr >
            ...
            <tr>
                <td colspan="10" style="text-align: center;font-size: 16px;font-weight: bold;">Invoice</td>
            </tr>
            ...
            <tr style="background: #c3c3c3; row-span: 2">
                ...
                <td  style="border-left: 0.2px solid grey;font-size: 13px;font-weight: bold;text-align: center;width: 15%">BAHT</td>
                <td  style="border-left: 0.2px solid grey;border-right: 0.2px solid grey;font-size: 13px;font-weight: bold;text-align: center;width: 15%">TOTAL</td>
            </tr>
            <?php $rows = 0; ?>
            <?php $sumqty = 0; ?>
            <?php $sumline = 0; ?>
            ...
            <?php foreach ($modelline as $value):?>
                ...
                //$sumline = number_format($value->qty * $value->price,0);
                $sumtotal = $sumtotal + number_format($value->qty * $value->price,0);
                ?>
                <?php $rows +=1; ?>
                <tr style="border: 0.5px solid black;border-bottom:none;border-collapse: collapse;">
                    ...
                    <td style="border-left: 0.2px solid grey;font-size: 12px;font-weight: normal;padding-left: 5px;text-align: left"><?=\backend\models\Product::findProductinfo($value->product_id)->product_code;?></td>
