    ...
    <div class="panel">
        <div class="panel-heading">
            <div style="border: 1px solid orange;width: 300px;text-align: center;border-radius: 25px;padding: 5px 0px 5px 0px;">
                <?php echo "เลขที่ใบสั่งซื้อ ".$sale_no;?>
            </div>
...
<!--                                </td>-->
                                ...
                                <td style="text-align: center;vertical-align: middle">
                                    <?php echo \backend\models\Product::findOrigin($query[$i]['product_id'])?>
                                </td>
                                <td style="vertical-align: middle">
                                    <input type="text" class="form-control line_transport_out_no" name="line_transport_out_no[]" style="width: 100px;" value="<?=$query[$i]['transport_out_no']?>">
                                </td>
                                <td style="vertical-align: middle">
                                    <input type="text" class="form-control line_transport_out_line_num" name="line_transport_out_line_num[]" readonly style="width: 100px;" value="<?=$query[$i]['transport_out_line_num']?>">
                                </td>
                                <td style="vertical-align: middle">
                                    <input type="date" class="form-control line_transport_out_date" name="line_transport_out_date[]" value="<?=date('Y-m-d', strtotime($query[$i]['transport_out_date']))?>">
                                </td>
                                <td style="vertical-align: middle">
                                    <?=$query[$i]['inv_no']?>
                                </td>
                                <td style="vertical-align: middle">
                                    <?=date('d-m-Y',strtotime($query[$i]['inv_date']))?>
                                </td>
                                <td style="vertical-align: middle">
                                ...
                                <td style="vertical-align: middle">
                                    <input type="text" style="width: 200px;" class="form-control line_kno_out_no" name="line_kno_out_no[]" value="<?=$query[$i]['kno_out_no']?>">
                                </td>
                                <td style="vertical-align: middle">
                                    <input type="date" class="form-control line_kno_out_date" name="line_kno_out_date[]" value="<?=date('Y-m-d',strtotime($query[$i]['kno_out_date']))?>">
                                </td>
                            </tr>
                        <?php endfor;?>
                    <?php endif;?>
