    ...
    <div class="col-lg-12">
        ...
        <table class="table" border="0" style="width: 100%;border-collapse: collapse;">
            ...
            <tr style="background: #c3c3c3;" rowspan="2">
                ...
                <td colspan="3" style="border: 0.2px solid grey;font-size: 14px;font-weight: bold;text-align: center">
                    Packing
                </td>
                <td style="border: 0.2px solid grey;border-bottom: 0px;font-size: 14px;font-weight: bold;text-align: center;width: 15%">
                    Net weight
                </td>
                <td style="border: 0.2px solid grey;border-bottom: 0px;font-size: 14px;font-weight: bold;text-align: center;width: 15%">
                    Gross weight
            ...
            <tr style="background: #c3c3c3; row-span: 2">
                ...
                <td style="border-left: 0.2px solid grey;font-size: 13px;font-weight: bold;text-align: center"></td>
                <td style="border-left: 0.2px solid grey;font-size: 13px;font-weight: bold;text-align: center"></td>
                <td style="border-left: 0.2px solid grey;font-size: 14px;font-weight: bold;text-align: center">Bottle
                </td>
                <td style="border-left: 0.2px solid grey;font-size: 14px;font-weight: bold;text-align: center">Litre
                </td>
                <td style="border-left: 0.2px solid grey;font-size: 14px;font-weight: bold;text-align: center">Alkohol
                </td>
