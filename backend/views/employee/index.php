...
<div class="employee-index">
    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            <div class="btn-group">
                <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างพนักงาน'), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="pull-right">
                        <form id="form-perpage" class="form-inline" action="<?=Url::to(['employee/index'],true)?>" method="post">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'contentOptions' => ['style' => 'vertical-align: middle'],
                'value'=>function($data){
                    return \backend\models\Section::findName($data->section_id);
                }
            ],
