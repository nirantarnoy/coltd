...
class QueryPicking extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['created_at', 'require_date', 'currency', 'customer_id', 'trans_date', 'product_id', 'status', 'warehouse_id'], 'integer'],
            [['qty', 'price'], 'number'],
            [['permit_date', 'transport_in_date', 'excise_date'], 'safe'],
            [['sale_no', 'permit_no', 'transport_in_no', 'excise_no','name','engname'], 'string', 'max' => 255],
        ];
    }
