...
/**
 * This is the model class for table "query_product_inbound".
 *
 ...
 */
class QueryProductInbound extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['excise_date'], 'safe'],
            [['product_code', 'name', 'description', 'barcode', 'origin', 'engname', 'group_name', 'excise_no', 'geolocation'], 'string', 'max' => 255],
        ];
    }
